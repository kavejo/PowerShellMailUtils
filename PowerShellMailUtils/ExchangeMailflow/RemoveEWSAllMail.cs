...
{
    [Cmdlet("Remove", "EWSAllMail")]
    [OutputType(typeof(MailflowMonitoringData))]
    [CmdletBinding()]

    public class RemoveEWSAllMail : Cmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                timer.Start();
                WriteVerbose(String.Format("Deleting <{0}> messages", inbox.TotalCount));
                inbox.Empty(DeleteMode.HardDelete, false);
                timer.Stop();
